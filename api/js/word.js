//i have pretended to use word api which will contain an object and i have printed definition from all
//the result of the word api  thn i have printed it in dom.
console.log("welcom to th vs code");
